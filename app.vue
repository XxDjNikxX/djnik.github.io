<template>
  ...
  <section
    class="relative bg-[url(https://i.redd.it/tm69aost3sea1.jpg)] bg-cover bg-center bg-no-repeat"
  >

  
    <div class="relative flex h-dvh lg:items-center lg:px-5">
      <div class="py-20 relative px-20 border-2 border-dashed border-color-black mx-auto mr-5">
        <h1 class="font-body text-5xl font-extrabold text-right text-white">
          Hey!
        </h1>
